...
from ics_v1_mencom.items import IcsV1SiteMapLinksItem, IcsV1PricingItem, IcsV1PDPItem, IcsV1AssetItem,IcsV1Item

class IcsV1MencomPipeline:
    ...
    def process_item(self, item, spider):
        ...
        if isinstance(item, IcsV1Item):
            self.insert_item(item, spider, db.xml_zip)
